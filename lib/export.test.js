...
describe('export', function(){
	...
	describe('png', function(){
		...
		it ('should refresh the png if refresh option is set', function(){
			childProcess.exec = sandbox.spy();
			sandbox.stub(process, 'cwd', function() { return 'c:\\hello';});

			exporter.png('MyWorkbook/MySheet', { refresh: true } , function(){});

			expect(childProcess.exec.args[0][0]).to.equal('tabcmd export MyWorkbook/MySheet?:refresh=yes --png -f c:\\hello\\output\\MyWorkbook\\MySheet');
		});
